...
$sql = "SELECT p.id, p.picture_main, p.name, p.price FROM products p
    ...
    WHERE s.subcategory_name = 'Sveston Watch'
    LIMIT 20";
...
<body>
    ...
    <section class="product-grid">
        <div class="container">
            <h2 class="section-title">Sveston 2 Watches</h2>
            <div class="grid">
                <?php
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class='product-card' data-product-id='" . $row['id'] . "'>
                            ...
                            <div class='product-actions'>
                                <form method='POST' action='s_sveston3.php'>
                    ...
                    echo "<p>No products found for Sveston Watch.</p>";
                }
                ?>
            </div>
        </div>
